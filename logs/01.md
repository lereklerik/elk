```shell
netology@netology:~/Projects/elk/roles/elasticsearch$ molecule test
...
Finished with 2 failure(s), 0 warning(s) on 10 files.
...
ok: [localhost] => (item=es-hot)
ok: [localhost] => (item=es-warm)
...
playbook: /home/netology/Projects/elk/roles/elasticsearch/molecule/default/converge.yml
...
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '533792486147.64581', 'results_file': '/home/netology/.ansible_async/533792486147.64581', 'changed': True, 'item': {'depends_on': ['es-warm'], 'groups': ['elk'], 'image': 'docker.elastic.co/elasticsearch/elasticsearch:7.16.3', 'name': 'es-hot', 'network': ['elastic'], 'ports': ['9200:9200'], 'pre_build_image': True, 'volumes': ['data01:/usr/share/elasticsearch/data']}, 'ansible_loop_var': 'item'})
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '950355456986.64609', 'results_file': '/home/netology/.ansible_async/950355456986.64609', 'changed': True, 'item': {'groups': ['elk'], 'image': 'docker.elastic.co/elasticsearch/elasticsearch:7.16.3', 'name': 'es-warm', 'network': ['elastic'], 'pre_build_image': True, 'volumes': ['data02:/usr/share/elasticsearch/data']}, 'ansible_loop_var': 'item'})
...
+++ after: /home/netology/.ansible/tmp/ansible-local-64921gul0wltd/tmpkw1s64bg/elasticsearch.yml.j2
@@ -1,2 +1,9 @@
...
changed: [es-hot]
--- before: /usr/share/elasticsearch/config/elasticsearch.yml
+++ after: /home/netology/.ansible/tmp/ansible-local-64921gul0wltd/tmpxr6qo24v/elasticsearch.yml.j2
@@ -1,2 +1,9 @@
-cluster.name: "docker-cluster"
+path.data: /var/lib/elasticsearch
+path.logs: /var/log/elasticsearch
...
PLAY RECAP *********************************************************************
es-hot                     : ok=4    changed=0    unreachable=0    failed=0    skipped=1    rescued=0    ignored=0
es-warm                    : ok=4    changed=0    unreachable=0    failed=0    skipped=1    rescued=0    ignored=0
...
PLAY RECAP *********************************************************************
es-hot                     : ok=1    changed=0    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
es-warm                    : ok=1    changed=0    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
